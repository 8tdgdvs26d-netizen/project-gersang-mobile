...
2. **`Gersang_V30_Claude_Handoff_2026-09-15.md`**（Google Drive）— 新接手、context遺失、版本交接，或需要確認程式基準（HEAD SHA、checkpoint分支、版本號）時必須讀取。
3. **`Gersang_Mobile_Handoff_Pack_v0.4.md`**（Google Drive）— Q001–Q800審核後嘅日常canonical設計基準。涉及遊戲設計、規則或系統行為嘅任務必須讀取相關內容。已定案內容不可因舊資料不同而自行重開。
4. **`Gersang_Mobile_Core_Architecture_v0.4_800_Questions.xlsx`**（Google Drive）— 作完整設計證據及歷史參考。**唔需要每個任務完整重讀全部800題**；只喺任務涉及相關題目、Handoff Pack未涵蓋必要細節、需要追溯決定或發現矛盾時，讀取相關部分。
