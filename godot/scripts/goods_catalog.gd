...
const GOODS := [
	{"id": "test_good_01", "display_name": "測試商品一", "capacity_cost": 1, "base_value": 100},
	{"id": "test_good_02", "display_name": "測試商品二", "capacity_cost": 1, "base_value": 250},
	{"id": "test_good_03", "display_name": "測試商品三", "capacity_cost": 2, "base_value": 500},
	{"id": "test_good_04", "display_name": "測試商品四", "capacity_cost": 2, "base_value": 1000},
	{"id": "test_good_05", "display_name": "測試商品五", "capacity_cost": 3, "base_value": 2000},
	{"id": "test_good_06", "display_name": "測試商品六", "capacity_cost": 4, "base_value": 4000},
]
...
static func get_unit_size(good_id: Variant) -> int:
	return get_capacity_cost(good_id)


## Capacity is quantity x this per-item TEST VALUE. Stack display never gives
## a capacity discount.
static func get_capacity_cost(good_id: Variant) -> int:
	return get_good(good_id).get("capacity_cost", 0)
