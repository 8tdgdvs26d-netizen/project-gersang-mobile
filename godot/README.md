...
M1-03 Camera Follow builds on the accepted M1-02 player movement:
...
`Myrial: Unwritten M1-03 camera follow ready`

## Deliberately not included

M1-03 does not add camera smoothing or shake, world boundaries, obstacle collision,
Y-sorting, mobile touch controls, cities, economy, combat, monsters, online systems,
saved-game migration, production UI, or final art. The guide lines and origin marker
are temporary verification visuals, not world art. Those excluded features require
separate approved work packages and evidence.
