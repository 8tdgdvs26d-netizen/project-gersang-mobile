...
async function api(req,res){
  ...
  if(req.method==='GET'&&u.pathname==='/api/health')return reply(res,200,{ok:true,version:'0.7.3',phase:'P2 Skill Target and Cooldown UX'});
