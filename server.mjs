...
const skillDefinitions={hero:[{id:'heavy-strike',name:'重擊',damage:32,range:2,cooldownMs:4000,type:'NORMAL'}]};
...
async function api(req,res){
  ...
  if(req.method==='GET'&&u.pathname==='/api/health')return reply(res,200,{ok:true,version:'0.7.4',phase:'P2 Skill Combat Feedback'});
